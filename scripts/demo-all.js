...
show("Calm", {
  model: "opus-4.8", effort: "MAX", lv: 7, tokens: 47200,
  rows: [
...
show("Danger + level up", {
  model: "opus-4.8", effort: "MAX", lv: 8, tokens: 64000,
  rows: [
    { name: "Weekly", pct: 82, reset: "2d" },
    { name: "5-Hour", pct: 100, reset: "1h" },
    { name: "Context", pct: 93, reset: "—" },
  ],
}, { event: "LEVEL UP!  you are now Lv.8" });

show("Cold start (rate limits not yet known)", {
  model: "sonnet-5", effort: "—", lv: 1, tokens: 0,
  rows: [
...
show("ASCII fallback frame", {
  model: "haiku-4.5", effort: "LOW", lv: 2, tokens: 12000,
  rows: [
